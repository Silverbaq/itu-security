...
High                         & \begin{tabular}[c]{@{}l@{}}Complete shutdown of the system, \\ user data is compromised, a major loss \\ in asset value, complete loss of the customers confidence\end{tabular} \\ \hline
